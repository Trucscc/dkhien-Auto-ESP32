...
//     //trangthai();
//     //document.location.reload();     // refresh the entire document
//    }, 120000);
// };   
...
//     setInterval("location.reload(true)",time);     // Thực hiện nhiều lần mỗi lần chách nhau time 1giây(1000)
//   }

// fetch('examples/example.json')                    //Fetch API là một API đơn giản cho việc gửi và nhận requesst bằng js. Fetch giúp cho việc thực hiện các yêu cầu web và xử lý phản hồi dễ dàng hơn so với XMLHttpRequest cũ.
